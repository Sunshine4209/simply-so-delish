...
function wpcr_style_options() { 
	...
	<style type="text/css">
		...
		.rating:not(:checked) > label:hover ~ label {
			...
			/*importanttext-shadow:1px 1px #bbb, 2px 2px #666, .1em .1em .2em rgba(0,0,0,.5);*/
		}
		...
		.wpcr_aggregate{float: left;display: inline-block;width: 100%;line-height: 20px;margin-left: -7px;}
